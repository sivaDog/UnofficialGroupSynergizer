local DungeonData={ 
	[1]={--Maj al-Ragath
		...
		{en="Wayrest Sewers I", ru="Канализация Вэйреста I", de="Kanalisation von Wegesruh I", fr="Égouts d'Haltevoie I",
		...
		{en="Wayrest Sewers II", ru="Канализация Вэйреста II", de="Kanalisation von Wegesruh II", fr="Égouts d'Haltevoie II",
	...
	[2]={--Glirion the Redbeard
		...
		{en="Arx Corinium", ru="Аркс-Кориниум", de="Arx Corinium", fr="Arx Corinium",
		...
		{en="Direfrost Keep", ru="Крепость Лютых Морозов", de="Burg Grauenfrost", fr="Donjon d'Affregivre",
			normal={id=11, ac=357}, vet={id=319, ac=1623, hm=1628, tt=1626, nd=1627}},
		{en="Volenfell", ru="Воленфелл", de="Volenfell", fr="Volenfell",
			normal={id=12, ac=391}, vet={id=304, ac=1629, hm=1634, tt=1632, nd=1633}},
		{en="Selene's Web", ru="Паутина Селены", de="Selenes Netz", fr="Selene's Web",
			normal={id=16, ac=417}, vet={id=313, ac=1635, hm=1640, tt=1638, nd=1639}},
		{en="Blessed Crucible", ru="Священное Горнило", de="Gesegnete Feuerprobe", fr="Creuset béni",
	...
	[3]={--Urgarlag Chief-bane (DLC)
		...
		{en="The Dread Cellar", ru="Ужасный Подвал", de="Schreckenskeller", fr="Cave d'effroi",
		...
		{en="Oathsworn Pit", ru="Oathsworn Pit", de="Grube der Eidgeschworenen", fr="Fosse aux fidèles",
			normal={id=638, ac=3810}, vet={id=639, ac=3811, hm=3812, tt=3813, nd=3814}},
		{en="Bedlam Veil", ru="Bedlam Veil", de="Schleier des Aufruhrs", fr="Voile des fous",
			normal={id=640, ac=3851}, vet={id=641, ac=3852, hm=3853, tt=3854, nd=3855}},
		{en="Exiled Redoubt", ru="Exiled Redoubt", de="Schanze der Abgeschiedenen", fr="Redoute de l'Exil",
			normal={id=855, ac=4109}, vet={id=856, ac=4110, hm=4111, tt=4112, nd=4113}},
		{en="Lep Seclusa", ru="Lep Seclusa", de="Lep Seclusa", fr="Lep Seclusa",
